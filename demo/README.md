...
* [photomaker](https://huggingface.co/spaces/TencentARC/PhotoMaker)  or [IP adapter](https://huggingface.co/spaces/multimodalart/Ip-Adapter-FaceID)
...
[text and question from a image to text](https://huggingface.co/spaces/vikhyatk/moondream1)
...
[colab introduction](https://colab.research.google.com/github/satwikkansal/gym-dual-taxi/blob/master/draft.ipynb)
